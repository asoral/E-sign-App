...
<Modal
  ...
  footer={null}
  className="glass-modal text-gray-700 max-w-prose"
>
  <div className="m-3 max-h-[70vh] overflow-y-auto doc-temp-scroll-container">
    <p className="mb-2 text-xl text-white px-4 pt-4">
      {modalContent?.subject}
    </p>
    <div className="relative flex gap-3 px-4">
      <p className={`mb-4 ${statusClasses} inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium text-white`}>
        {modalContent?.status}
      </p>
      <Tooltip
        title={
    ...
    <div className="mb-4">
      <p className="mb-2 text-lg text-white px-4 font-bold tracking-tight">
        Description
      </p>
      <p
        className="text-justify text-white leading-relaxed mt-2 mb-4 px-4"
